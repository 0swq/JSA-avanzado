...
router.get('/usuario/:usuarioId', resenaControlador.obtenerPorUsuario);
router.get('/:id', resenaControlador.obtenerPorId);
router.post('/', validar(crearResenaSchema), resenaControlador.crear);
router.patch('/:id', validar(actualizarResenaSchema), resenaControlador.actualizar);
router.delete('/:id', middlewareRol(['admin']), resenaControlador.eliminar);
